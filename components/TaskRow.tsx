...
import { GREEN_TINT, HAIRLINE, INK, MUTED, PAPER, SANS, SOFT_SHADOW } from "@/lib/constants";
    ...
    <div
      ...
      {pending > 0 && !task.done && (
        <span style={{
          ...
          background: GREEN_TINT, color: INK, borderRadius: RADIUS.pill, padding: `${SPACE.xs}px ${SPACE.sm}px`,
