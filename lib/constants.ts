...
//   オレンジ 2.62 / 5.27 ／ 緑 3.39 / 4.07 ／ ライム **1.07** / 12.86 ／
//   水色 1.58 / 8.76 ／ ラベンダー 1.31 / 10.56 ／ 濃い紫 4.18 / 3.31 ／
//   灰紫 1.59 / 8.70 ／ 朱 3.98 / 3.47。
...
export const PALETTE = {
  naranja:  "#FD6F03",  // オレンジ   … TASK（画像。第125巡の #FD6A23 とほぼ同じ）
  verde:    "#549543",  // 緑         … バショ（画像）
  amarillo: "#DAFE1E",  // ライム     … モノ（画像。いちばん面積が大きい）
  azul:     "#92CDFE",  // 水色       … ジョウホウ（画像）
  lila:     "#E7D1FC",  // ラベンダー … JOURNAL（画像）
  morado:   "#8E5CD8",  // 濃い紫     … タイケン（★画像のラベンダーを深めた）
  cielo:    "#C7C4D6",  // 灰紫       … ニュース（★画像の地を沈めた＝いちばん退く）
  rojo:     "#E0400F",  // 朱         … 危険だけ（★画像のオレンジを赤へ寄せた）
} as const;
...
//   使っているので変えない。**
export const SCHEME = {
  work: PALETTE.azul,          // 水色     … ジョウホウ(info) ／選ばれている
  life: PALETTE.verde,         // 緑       … バショ(place)    ／肯定
  growth: PALETTE.morado,      // 濃い紫   … タイケン(experience)
  wellness: PALETTE.amarillo,  // ライム   … モノ(thing)
