...
//   普通(1.0)の半分強へ戻し、投げ(`FLICK_K`)は下げて**釣り合いを保つ
...
/** ★指の効き。1 なら「1ピッチ動かしたら1つ進む」。第59巡の 0.2 → 0.55。 */
export const SCROLL_GAIN = 0.55;
/** 離したあとの減衰(1フレームあたり)。 */
export const SCROLL_DECAY = 0.9;
/** 投げの強さ。指の速さ(px/イベント)をどれだけ先へ伸ばすか。第59巡の 0.18 → 0.14
 *  (`SCROLL_GAIN` を上げたぶん、掛け算の総量が上がりすぎないように下げる)。 */
export const FLICK_K = 0.14;
